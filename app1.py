...
json_file_path = "D:/BE Project/Emotion recognition/Final_Project/Contents/Activities.json"
...
# Face Expression Recognition:
  ...
  if ferChoice == "Upload Image":
    ...
    #Saving upload
      with open(os.path.join("D:/BE Project/Emotion recognition/Final_Project/Contents", 'image.jpg'),"wb") as f:
  ...
  if runFerBtn:
    try:
      exec(open("D:/BE Project/Emotion recognition/Final_Project/FaceRecognition (2).py").read())
    except:
      st.write("Please re-capture the image")
        
    emotionFaceFinal = open('D:/BE Project/Emotion recognition/Final_Project/Contents/FinalFaceEmotion.txt', 'r').read()
    st.subheader("Predicted Emotion: " + emotionFaceFinal)
    # st.subheader(emotionFaceFinal)
    image = Image.open('D:/BE Project/Emotion recognition/Final_Project/Contents/faceemotion.jpg')
    st.image(image)
...
# Speech Emotion Recognition:
  ...
  if audio_file is not None:
    ...
    sound.export("D:/BE Project/Emotion recognition/Final_Project/Contents/audio.wav", format="wav")
  ...
  if runSerBtn:
    exec(open("D:/BE Project/Emotion recognition/Final_Project/SpeechRecognition (2).py").read())
    emotionSpeechFinal = open('D:/BE Project/Emotion recognition/Final_Project/Contents/FinalSpeechEmotion.txt', 'r').read()
    st.subheader("Predicted Emotion :")
    st.subheader(emotionSpeechFinal)
    image = Image.open('D:/BE Project/Emotion recognition/Final_Project/Contents/speechemotion.jpg')
    st.image(image)
