...
if __name__ == '__main__':
  ...
  model = load_learner('D:/BE Project/Emotion recognition/Final_Project/Contents/speech_1.pkl')
  p = pathlib.Path('D:/BE Project/Emotion recognition/Final_Project/Contents/audio.wav')
  ...
  p = os.path.join('D:/BE Project/Emotion recognition/Final_Project/Contents', "{}.jpg".format(str(count)))
  plt.savefig(p)

  p1 ='D:/BE Project/Emotion recognition/Final_Project/Contents/1.jpg'
  ...
  file1 = open("D:/BE Project/Emotion recognition/Final_Project/Contents/FinalSpeechEmotion.txt", "w")
  file1.write(text2.capitalize())
  file1.close()
  cv2.imwrite("D:/BE Project/Emotion recognition/Final_Project/Contents/speechemotion.jpg", img)